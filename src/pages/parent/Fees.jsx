...
import { feeDetails } from '../../data/mockParentData';
...
export default function ParentFees() {
  ...
  return (
    <div className="parent-fees-page animate-fade-in">
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          <h1>Fee Payments & Ledgers</h1>
          <p>Pay your ward's semester fees securely with 1-click & download GST receipts</p>
        </div>
